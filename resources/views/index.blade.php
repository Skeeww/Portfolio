...
<body>
    ...
    <div class="mx-auto lg:px-64 modal" id="respmenu">
        ...
        <div class="flex flex-col justify-between text-3xl uppercase font-thin">
            ...
            <a href="#cv" class="bg-purple-400 hover:bg-purple-600 transition text-white font-bold rounded-2xl p-5 my-4 close_modal">CV</a>
        </div>
    </div>
    <!--
        Python
    ...
    <div class="mx-auto lg:px-64 modal skill-modal" id="python">
        ...
        <div class="flex flex-col lg:flex-row w-full mt-16">
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:mr-5">
                <h4 class="text-2xl"><a href="https://colab.research.google.com/drive/1rwbMVbh7isPr2K9EU8GWl_4tqyZT9j-I">Word Generator</a></h4>
                <p>Programme permettant la création de mots sur la base d’une matrice probabiliste générée par une liste de mots.</p>
            ...
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:ml-5">
                ...
                <p>Web scrapper récupérant les nouvelles offres d'alternance sur Linkedin en les envoyant via un Webhook dans un channel Discord.</p>
                <ul class="inline-block text-xs text-white mt-5">
                    <li class="inline px-2 py-1 bg-black rounded-2xl">Python</li>
            ...
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:ml-5">
                ...
                <p>Logiciel de relais entre une base de données MongoDB et Pusher.io pour acheminer les données télémétriques d'une fusée à eau.</p>
                <ul class="inline-block text-xs text-white mt-5">
                    <li class="inline px-2 py-1 bg-black rounded-2xl">Python</li>
    ...
    <div class="mx-auto lg:px-64 modal skill-modal" id="javascript">
        <button class="my-10 text-5xl close_modal"><i class="lni lni-cross-circle"></i></button>
        <h1 class="text-6xl mb-10 font-black text-orange">Javascript / <span class="text-blue-600">Typescript</span></h1>
        ...
        <div class="flex flex-col lg:flex-row w-full mt-16">
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:ml-5">
                ...
                <p>Bot pour le logiciel Discord agencé autour d'une architecture fait maison permettant l'exécution de tâches avec une récurrence ainsi que de commandes.</p>
                <ul class="inline-block text-xs text-white mt-5">
            ...
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:ml-5">
                ...
                <p>Système de modal inspiré par Bootstrap, ne nécessitant aucune librairie externe. Développé dans le cadre de ce site</p>
                <ul class="inline-block text-xs text-white mt-5">
                    <li class="inline px-2 py-1 bg-black rounded-2xl">Typescript</li>
            ...
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:ml-5">
                <h4 class="text-2xl"><a href="https://glitch.com/edit/#!/vue-twitch-tchat">Vue Twitch Tchat</a></h4>
                <p>Application Vue.JS retranscrivant un fil de discussion Twitch sur une page web avec la prise en charge d'émotes.</p>
                <ul class="inline-block text-xs text-white mt-5">
                    <li class="inline px-2 py-1 bg-black rounded-2xl">Typescript</li>
    ...
    <div class="mx-auto lg:px-64 modal skill-modal" id="java">
        ...
        <div class="flex flex-col lg:flex-row w-full mt-16">
            ...
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:ml-5">
                ...
                <p>Plugin Minecraft pour serveur Spigot délivrant un classement des meilleurs factions en s'interfaçant avec un plugin de MassiveCraft.</p>
                <ul class="inline-block text-xs text-white mt-5">
                    <li class="inline px-2 py-1 bg-black rounded-2xl">Java</li>
                    <li class="inline px-2 py-1 bg-black rounded-2xl">Paper API</li>
                </ul>
            ...
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:ml-5">
                ...
                <p>Plugin Minecraft pour serveur Spigot utile pour créer des arènes afin de faire des duels entre joueurs.</p>
                <ul class="inline-block text-xs text-white mt-5">
                    <li class="inline px-2 py-1 bg-black rounded-2xl">Java</li>
                    <li class="inline px-2 py-1 bg-black rounded-2xl">Paper API</li>
                </ul>
    ...
    <div class="mx-auto lg:px-64 modal skill-modal" id="web">
        ...
        <div class="flex flex-col lg:flex-row w-full mt-16">
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:mr-5">
                <h4 class="text-2xl"><a href="https://infolannion.com/h14/">Nos Liens Sociaux Durant L'épidémie</a></h4>
                <p>Site réalisé dans le cadre du PPP sur le thème de l'impact d'internet et des réseaux sociaux sur nous durant l'épidémie.</p>
                <ul class="inline-block text-xs text-white mt-5">
            ...
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:ml-5">
                ...
                <p>La Confrérie est une communauté de plusieurs milliers de joueurs se réunissant sur différents serveurs de jeux.</p>
                <ul class="inline-block text-xs text-white mt-5">
                    <li class="inline px-2 py-1 bg-black rounded-2xl">HTML/CSS</li>
                    <li class="inline px-2 py-1 bg-black rounded-2xl">Javascript</li>
                    <li class="inline px-2 py-1 bg-black rounded-2xl">FontAwesome</li>
            ...
            <div class="flex-grow border border-gray-800 border-4 p-5 rounded lg:ml-5">
                ...
                <p>Outil d'administration, modération, rédaction pour l'ancien serveur Minecraft BadBlock réunissant des centaines de joueurs.</p>
                <ul class="inline-block text-xs text-white mt-5">
                    <li class="inline px-2 py-1 bg-black rounded-2xl">HTML/CSS</li>
                    <li class="inline px-2 py-1 bg-black rounded-2xl">Bootstrap</li>
    ...
    <div class="relative h-screen w-screen flex justify-center nav-trigger" id="home">
        <svg class="w-full pb-20 sm:w-1/4 z-10" viewBox="0 0 940 539" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="Logo 1">
                ...
                <linearGradient id="paint1_linear" x1="939" y1="3.99995" x2="46.4998" y2="524.5" gradientUnits="userSpaceOnUse">
                <stop/>
                <stop offset="1" stop-color="#10F1FF"/>
                </linearGradient>
                </defs>
        </svg>            
        <svg style="z-index: -1;" class="absolute top-0 left-0 w-full h-full" preserveAspectRatio="none" viewBox="0 0 411 353" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!--
        Navbar
    -->
    <div class="fixed bottom-0 left-1/2 transform -translate-x-1/2 h-16 bg-white w-16 lg:w-1/3 rounded-full shadow-xl text-center mb-5" style="z-index: 9999;" id="nav">
        <ul class="hidden lg:inline-flex w-full justify-around h-full items-center" id="navbar">
            ...
            <li><a href="#cv" class="bg-purple-400 hover:bg-purple-600 transition text-white font-bold rounded-2xl px-3 py-2">CV</a></li>
        </ul>
        <button class="lg:hidden cursor-pointer p-5 modal" targeted-modal="respmenu"><i class="lni lni-menu"></i></button>
    </div>
    <div class="lg:h-screen/2 w-screen absolute" style="z-index: -1;">
        <svg style="z-index: -1;" class="w-full h-full" preserveAspectRatio="none" viewBox="0 0 411 270" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="d-block h-auto container mx-auto lg:px-64 nav-trigger" id="aboutme">
        <div class="flex flex-col lg:flex-row justify-between mt-40">
            ...
            <div class="flex flex-col mx-12 lg:mx-0 lg:flex-row lg:w-1/4 lg:flex-col justify-around items-center mt-5 lg:mt-0">
            ...
            <div class="flex flex-col mt-10">
                <div class="inline-flex items-center">
                    ...
                    <div class="w-full ml-5">
                        ...
                        <h5><i class="lni lni-pin"></i> <a href="https://iut-lannion.univ-rennes1.fr/" class="text-green-light hover:underline">I.U.T de Lannion</a><i class="ml-4 lni lni-calendar"></i> Année d'obtention prévu: 2022</h5>
                        <hr>
                    </div>
                </div>
            ...
            <div class="flex flex-col mt-4">
                <div class="inline-flex items-center">
                    ...
                    <div class="w-full ml-5">
                        ...
                        <h5><i class="lni lni-pin"></i> <a href="https://lycee-ledantec.fr/" class="text-green-light hover:underline">Lycée Félix Le Dantec</a><i class="ml-4 lni lni-calendar"></i> Année d'obtention: 2020</h5>
                        <hr>
                    </div>
                </div>
                <p class="pl-12 ml-8 mt-2">Spécialité: <b>Sciences de l'Ingénieur</b><br>Option: <b>Sciences de l'Informatique et du Numérique</b></p>
            </div>
        </div>
    </div>
    <svg style="z-index: -1;" class="w-full h-full" preserveAspectRatio="none" viewBox="0 0 410 126" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 51.5008L205 25.7504L410 0V126C410 126 355.245 70.7004 219 50.8157C161.295 42.3939 90.5 46 0 51.5008Z" fill="#248DC8"/>
    </svg>
    <!--
        FUN FACTS
    -->
    ...
    <div class="relative w-full h-full nav-trigger" id="cv">
        <svg style="z-index: -1;" class="w-full h-screen bg-green-light lg:bg-transparent" preserveAspectRatio="none" viewBox="0 0 1920 1315" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="relative h-25 w-full bg-black text-white text-center p-10 nav-trigger" id="footer">
        <p>Copyright - Noan Perrot 2021-2022</p>
    </div>
    <script src="{{ asset('js/app.js') }}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=Document%2CWindow%2CArray.prototype.forEach%2Cdefault%2Ces6%2C%7Eviewport%2C%7Ehtml5-elements%2Csmoothscroll%2Cscroll%2CrequestAnimationFrame%2Cdocument%2CWebAnimations%2CElement"></script>
    <script>
